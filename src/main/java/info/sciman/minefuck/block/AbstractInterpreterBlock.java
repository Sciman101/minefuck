...
public abstract class AbstractInterpreterBlock extends HorizontalFacingBlock implements BlockEntityProvider {
    ...
    public AbstractInterpreterBlock(Settings settings) {
        super(settings);
    ...
    // Called when the power being supplied to the side of the block changes
    protected abstract void onSidePowerChanged(BlockState state, World world, BlockPos pos, InterpreterBlockEntity be, int power);
    ...
    public void neighborUpdate(BlockState state, World world, BlockPos pos, Block block, BlockPos fromPos, boolean notify) {
        ...
        if (be instanceof InterpreterBlockEntity) {
            ...
            if (!pos.offset(dir.getOpposite()).equals(fromPos)) {
                ...
                int sidePower = Math.max(world.getReceivedRedstonePower(pos.offset(dir.rotateYClockwise())),world.getReceivedRedstonePower(pos.offset(dir.rotateYCounterclockwise())));
                onSidePowerChanged(state,world,pos,interpreterBlockEntity,sidePower);
    ...
    public static void setHasBook(World world, BlockPos pos, BlockState state, boolean hasBook, boolean error) {
        if (world.getBlockState(pos).getBlock() instanceof AbstractInterpreterBlock) {
